(function ($, app) {
    ...
    $.onSwitchChange = function (el) {
        ...
        if (checked) {
            $.post(app.resolveUrl("~/api/vaccine-report/change-status"), { Value: val }, function () {
    ...
    $.download = function () {
        window.open(app.resolveUrl("~/api/vaccine-report/download?submissionDate=" + getSelectedDate()), "_blank");
    };
