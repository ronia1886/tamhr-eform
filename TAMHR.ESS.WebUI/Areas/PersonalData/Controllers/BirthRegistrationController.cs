...
namespace TAMHR.ESS.WebUI.Areas.PersonalData.Controllers
{
    ...
    /// <summary>
    /// Birth Registration API Manager
    /// </summary>
    [Route("api/" + ApplicationForm.FamilyRegistration)]
    public class BirthRegistrationApiController : FormApiControllerBase<BirthRegistrationViewModel>
    {
