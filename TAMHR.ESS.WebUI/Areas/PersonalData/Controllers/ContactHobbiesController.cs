...
namespace TAMHR.ESS.WebUI.Areas.PersonalData.Controllers
{
    ...
    /// </summary>
    [Route("api/" + ApplicationForm.ContactHobbies)]
    [Permission(PermissionKey.CreateContactHobbiesDataRequest)]
    public class ContactHobbiesController : FormApiControllerBase<OthersPersonalDataViewModel>
    {
