...
namespace TAMHR.ESS.WebUI.Areas.PersonalData.Controllers
{
    ...
    /// <summary>
    /// Marriage status API controller.
    /// </summary>
    [Route("api/" + ApplicationForm.MarriageStatus)]
    public class MarriageStatusApiController : FormApiControllerBase<MarriageStatusViewModel>
    {
        ...
        protected override void ValidateOnCreate(string formKey)
        {
            ...
            PersonalDataService.PreValidateMarriageStatus(ServiceProxy.UserClaim.NoReg);
