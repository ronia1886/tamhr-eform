...
namespace TAMHR.ESS.WebUI.Areas.Core.Controllers
{
    ...
    /// </summary>
    [Route("api/address2")]
    [Permission(PermissionKey.ManageAddress)]
    public class AddressApiController : ApiControllerBase
    {
    ...
    [Area("Core")]
    public class AddressController : MvcControllerBase
    {
        /// <summary>
        /// Core service object
        /// </summary>
        ...
        public async Task<IActionResult> RedirectTo(string formKey, Guid id)
        {
            ...
            return await View(fkey.FormKey, id);
        }
