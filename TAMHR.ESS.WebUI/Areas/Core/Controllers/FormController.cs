...
namespace TAMHR.ESS.WebUI.Areas.Core.Controllers
{
    ...
    /// </summary>
    [Route("api/form")]
    [Permission(PermissionKey.ManageForm)]
    public class FormApiController : ApiControllerBase
    {
    ...
    public class FormController : MvcControllerBase
    {
        ...
        public IActionResult Load(Guid id)
        {
            ...
            return PartialView("_FormEditForm", form);
        }
