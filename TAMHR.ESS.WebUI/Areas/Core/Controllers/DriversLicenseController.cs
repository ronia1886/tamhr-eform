...
namespace TAMHR.ESS.WebUI.Areas.Core.Controllers
{
    ...
    /// Form API Manager
    /// </summary>
    [Route("api/driverslicense-core")]
    [Permission(PermissionKey.ManageDriversLicense)]
    public class DriversLicenseApiController : ApiControllerBase
    {
    ...
    [Area("Core")]
    public class DriversLicenseController : MvcControllerBase
    {
        /// <summary>
        /// Core service object
        /// </summary>
