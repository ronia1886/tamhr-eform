...
namespace TAMHR.ESS.WebUI.Areas.Core.Controllers
{
    ...
    [Permission(PermissionKey.ManageFamilyRegist)]
    public class FamilyRegistApiController : ApiControllerBase
    {
    ...
    [Area("Core")]
    public class FamilyRegistController : MvcControllerBase
    {
        /// <summary>
        /// Core service object
        /// </summary>
