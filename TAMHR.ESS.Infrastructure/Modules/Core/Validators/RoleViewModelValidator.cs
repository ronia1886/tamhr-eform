...
namespace TAMHR.ESS.Infrastructure.Validators
{
    ...
    {
        public RoleViewModelValidator(ConfigService configService, IStringLocalizer<RoleViewModelValidator> localizer)
        {
            ...
            RuleFor(x => x.Permissions).NotEmpty()
                .WithMessage(localizer["Permission must be selected"].Value);
        }
    }
}
