...
{
    [Table("TB_R_VACCINE")]
    public partial class Vaccine : IEntityBase<Guid>
    {
        public Vaccine()
        {
            VaccineQuestionList = new List<VaccineQuestion>();
        }
        [Key]
        ...
        public bool SHAStatus { get; set; }
        public bool? HaveVaccine { get; set; }
        public string Status { get; set; }
        public bool? TAMVaccineAgreement { get; set; }
        public List<VaccineQuestion> VaccineQuestionList { get; set; }
    }
