...
{
    [Table("VW_ABNORMALITY_OVER_TIME")]
    public class AbnormalityOverTimeView : IEntityMarker
    {
        public Guid Id { get; set; }
        public Guid? AbnormalityOverTimeId { get; set; }
        public Guid? DocumentApprovalId { get; set; }
        public Guid? TimeManagementSpklRequestId { get; set; }
