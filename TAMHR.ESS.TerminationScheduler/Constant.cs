...
namespace TAMHR.ESS.Scheduler
{
    public  class Constanta
    {
        ...
        public static string ConnectionString()
        {
            ...
            //return "data source=52.163.124.126;initial catalog=TAMHR_ESS_PRD_20220103;persist security info=True;user id=sa;password=@git123456789;MultipleActiveResultSets=True;App=EntityFramework;";
