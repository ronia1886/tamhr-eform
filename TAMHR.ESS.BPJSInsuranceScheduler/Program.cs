...
namespace TAMHR.ESS.Scheduler
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var personalDataService = _serviceProvider.GetService<PersonalDataService>();
            var reminderService = _serviceProvider.GetService<ReminderService>();

            // Log for starting service.
            Log.Information("Starting Service...");

            // Send email for termination reminder.
            
            DoAction(async () => await personalDataService.CheckBPJSInsurance(), "Success BPJS Insurance Scheduler");
